...
/**
 * Package: org.elastos.hive.elastoshiveandroiddemo.model
...
public class TokenResponse {
    ...
    public TokenResponse(String token_type, String scope, int expires_in, int ext_expires_in, String access_token, String refresh_token) {
