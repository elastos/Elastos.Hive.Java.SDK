...
public class TestData {
	public static final String TEST_RESOLVER_URL = "http://api.elastos.io:21606"; //Test Net
	public static final String MAIN_RESOLVER_URL = "http://api.elastos.io:20606"; //Main Net
	...
	public static final String userDid1_storepass = "password";

	//did:elastos:ibxKu7cqwTGdaHzUykGCVf74SHTsMtG84k
	public static final String appInstance1_name = "testapp";
	public static final String appInstance1_mn = "polar degree weapon crouch alarm scorpion between stand glow round catalog marine";
	public static final String appInstance1_phrasepass = "password";
	...
	public static final String userDid2_storepass = "password";

	//did:elastos:inc6Pb9eVQFDcPgoX9iR1Dp7TPbYfT6hzY
	public static final String appInstance2_name = "testapp1";
