...
public class ScriptController extends Controller {
	...
	public static ScriptController newInstance(Scripting scripting) {
		if(mInstance == null) {
			mInstance = new ScriptController(scripting);
		}

		return mInstance;
	}

	private ScriptController(Scripting scripting) {
